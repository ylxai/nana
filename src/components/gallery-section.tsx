...
export default function GallerySection() {
  // Menghapus state terkait lightbox untuk sementara
  ...
  // Hapus fungsi-fungsi lightbox untuk sementara
  ...
  return (
    <section id="gallery" className="py-20 bg-wedding-ivory">
          ...
          <div className="photo-grid">
            {photos.map((photo, index) => ( 
              ...
              <div 
                ...
                // Hapus onClick={() => openLightbox(index)} untuk sementara
              >
                <img
                  src={photo.url}
      ...
      {/* Hapus rendering PhotoLightbox untuk sementara */}
